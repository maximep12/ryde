...
function InputDateGroup({ className, ...props }: React.ComponentProps<typeof DateFieldAria>) {
...
function InputDateInput({ className, ariaLabel = 'date', ...props }: DateInputProps) {
  return (
    <DateInputAria
      {...props}
      className={cn(
      ...
      {(segment) => (
        <DateSegmentAria
          ...
          className={cn(
            ...
            'focus:bg-primary focus:text-background rounded px-1 py-0.5 focus:outline-hidden',
