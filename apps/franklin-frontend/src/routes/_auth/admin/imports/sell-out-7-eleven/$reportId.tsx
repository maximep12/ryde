...
export const Route = createFileRoute('/_auth/admin/imports/sell-out-7-eleven/$reportId')({
  component: ImportSellOut7ElevenReportPage,
  staticData: {
...
function ImportSellOut7ElevenReportPage() {
