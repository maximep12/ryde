...
export const Route = createFileRoute('/_auth/admin/imports/sell-in-targets/$reportId')({
  component: ImportSellInTargetsReportPage,
  staticData: {
...
function ImportSellInTargetsReportPage() {
