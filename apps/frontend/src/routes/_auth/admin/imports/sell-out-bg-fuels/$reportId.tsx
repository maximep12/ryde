...
export const Route = createFileRoute('/_auth/admin/imports/sell-out-bg-fuels/$reportId')({
  component: ImportSellOutBgFuelsReportPage,
  staticData: {
...
function ImportSellOutBgFuelsReportPage() {
