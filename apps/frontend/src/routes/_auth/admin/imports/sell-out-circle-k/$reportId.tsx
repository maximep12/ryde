...
export const Route = createFileRoute('/_auth/admin/imports/sell-out-circle-k/$reportId')({
  component: ImportSellOutCircleKReportPage,
  staticData: {
...
function ImportSellOutCircleKReportPage() {
