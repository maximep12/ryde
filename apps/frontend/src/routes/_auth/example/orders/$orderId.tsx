...
export const Route = createFileRoute('/_auth/example/orders/$orderId')({
...
function OrderDetailsPage() {
  ...
  // Register order number in sidebar when data loads
  React.useEffect(() => {
    if (order?.orderNumber) {
      setCurrentItem('/example/orders', order.orderNumber)
    }
  }, [order?.orderNumber, setCurrentItem])
